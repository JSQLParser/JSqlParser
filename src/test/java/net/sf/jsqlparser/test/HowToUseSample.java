...
public class HowToUseSample {
    ...
    void writeSQL() {
        ...
        SelectExpressionItem selectExpressionItem = new SelectExpressionItem().withExpression(new LongValue().withValue(1));
        ...
        PlainSelect select = new PlainSelect().addSelectItems(selectExpressionItem).withFromItem(table).withWhere(whereExpression);
