...
public class StatementDeParserTest {
  @Mock private ExpressionDeParser expressionDeParser;

  @Mock private SelectDeParser selectDeParser;
  ...
  public void shouldUseProvidedDeparsersWhenDeParsingInsert() throws JSQLParserException {
    ...
    SubSelect withItem1SelectBody = mock(SubSelect.class);
    SubSelect withItem2SelectBody = mock(SubSelect.class);
    ...
    withItem1.setSubSelect(withItem1SelectBody);
    withItem2.setSubSelect(withItem2SelectBody);
