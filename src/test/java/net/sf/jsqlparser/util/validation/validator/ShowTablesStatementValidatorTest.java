...
public class ShowTablesStatementValidatorTest extends ValidationTestAsserts {
    ...
    public void testValidationShowTables() throws Exception {
        for (String sql : Arrays.asList("SHOW TABLES", "SHOW EXTENDED FULL TABLES", "SHOW EXTENDED TABLES FROM db_name", "SHOW FULL TABLES IN db_name", "SHOW TABLES LIKE '%FOO%'", "SHOW TABLES WHERE table_name = 'FOO'")) {
