...
public class DatabaseMetaDataValidationTest extends ValidationTestAsserts {
    ...
    public void setupDatabase() throws SQLException {
        ...
        connection.prepareStatement("CREATE TABLE mytable (id bigint, ref bigint, description varchar(100), active boolean);").execute();
        connection.prepareStatement("CREATE TABLE mysecondtable (id bigint, description varchar(100), active boolean);").execute();
    ...
    public void testValidationAlterTable() throws JSQLParserException, SQLException {
        ...
        // column exists
        validateMetadata(sql, 1, 1, meta.clearCache(), false, "price");
    }
    ...
    public void testValidationDropView3Parts() throws JSQLParserException, SQLException {
        ...
        JdbcDatabaseMetaDataCapability meta = new JdbcDatabaseMetaDataCapability(connection, NamesLookup.UPPERCASE, false);
        // no errors
        validateNoErrors(sql, 1, DatabaseType.H2, meta);
    }
