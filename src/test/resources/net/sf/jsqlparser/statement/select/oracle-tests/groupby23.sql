...
--@FAILURE: select channel_desc,calendar_month_desc,country_iso_code,to_char(sum(amount_sold),'9,999,999,999')sales$,grouping(channel_desc)ch,grouping(calendar_month_desc)mo,grouping(country_iso_code)co from sales,customers,times,channels,countries where sales.time_id=times.time_id and sales.cust_id=customers.cust_id and customers.country_id=countries.country_id and sales.channel_id=channels.channel_id and channels.channel_desc in null group by having(grouping(channel_desc)=1 and grouping(calendar_month_desc)=1 and grouping(country_iso_code)=1)or(grouping(channel_desc)=1 and grouping(calendar_month_desc)=1)or(grouping(country_iso_code)=1 and grouping(calendar_month_desc)=1) recorded first on 1 May 2023, 23:34:56
--@FAILURE: select channel_desc,calendar_month_desc,country_iso_code,to_char(sum(amount_sold),'9,999,999,999')sales$,grouping(channel_desc)ch,grouping(calendar_month_desc)mo,grouping(country_iso_code)co from sales,customers,times,channels,countries where sales.time_id=times.time_id and sales.cust_id=customers.cust_id and customers.country_id=countries.country_id and sales.channel_id=channels.channel_id and channels.channel_desc in null and times.calendar_month_desc in null and country_iso_code in null group by having(grouping(channel_desc)=1 and grouping(calendar_month_desc)=1 and grouping(country_iso_code)=1)or(grouping(channel_desc)=1 and grouping(calendar_month_desc)=1)or(grouping(country_iso_code)=1 and grouping(calendar_month_desc)=1) recorded first on 1 May 2023, 23:39:45
--@FAILURE: select channel_desc,calendar_month_desc,country_iso_code,to_char(sum(amount_sold),'9,999,999,999')sales$,grouping(channel_desc)ch,grouping(calendar_month_desc)mo,grouping(country_iso_code)co from sales,customers,times,channels,countries where sales.time_id=times.time_id and sales.cust_id=customers.cust_id and customers.country_id=countries.country_id and sales.channel_id=channels.channel_id and channels.channel_desc in('direct sales','internet')and times.calendar_month_desc in('2000-09','2000-10')and country_iso_code in('gb','us')group by having(grouping(channel_desc)=1 and grouping(calendar_month_desc)=1 and grouping(country_iso_code)=1)or(grouping(channel_desc)=1 and grouping(calendar_month_desc)=1)or(grouping(country_iso_code)=1 and grouping(calendar_month_desc)=1) recorded first on 1 May 2023, 23:42:26