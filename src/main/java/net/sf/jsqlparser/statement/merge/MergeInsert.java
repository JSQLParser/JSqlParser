...
public class MergeInsert implements Serializable {
    ...
    public String toString() {
        return " WHEN NOT MATCHED THEN INSERT " + (columns.isEmpty() ? "" : PlainSelect.getStringList(columns, true, true)) + " VALUES " + PlainSelect.getStringList(values, true, true) + (whereCondition != null ? " WHERE " + whereCondition : "");
    }
